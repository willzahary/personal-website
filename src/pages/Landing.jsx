    ...
    return (
        <div className="landing">
            <div className="landing-text">
                ...
                <p className="landing-cities">I'm originally from <a className='map' target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Edmonton,+AB+T6J">Edmonton</a>, but I live in <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Mile+End,+Montreal,+QC">Montreal</a> right now. I'm moving to <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/San+Francisco,+CA,+USA">San Francisco</a> indefinitely in September 2025.</p>
                <Links />
            </div>

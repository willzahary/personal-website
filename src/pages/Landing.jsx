    ...
    return (
        <div className="landing">
            <div className="landing-text">
                ...
                <p className="landing-cities">I'm originally from <a className='map' target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Edmonton,+AB+T6J">Edmonton</a>, but I live in <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Capitol+Hill,+Seattle,+WA">Seattle</a> right now.</p>
                <Links />
            </div>
